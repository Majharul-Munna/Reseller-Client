...
const AddProduct = () => {
    ...
    const handleAddProduct = data => {
        ...
        .then(imgData => {
            ...
            fetch('https://re-seller-server.vercel.app/addedProducts', {
                method: 'POST',
                headers: {
    ...
    return (
        <div className='w-2/3 p-7'>
            <h3 className='text-3xl my-5'>Add a product</h3>
            <form onSubmit={handleSubmit(handleAddProduct)}>
                <div className='lg:flex'>
                    ...
                    <div className="form-control w-full max-w-xs">
                            <label className="label">
                                <span className="label-text">Please Select Your Product Categories</span>
                            </label>
                            ...
                            <option value="Educational">Others</option>
                        </select>
                        </div>
                        <div className="form-control w-full max-w-xs">
                            <label className="label">
