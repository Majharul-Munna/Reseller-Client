    ...
    return (
        <div>
            <div className='text-center mb-4'>
                ...
                <h2 className="text-3xl font-semibold text-orange-600 mt-2 mb-2">Our Educational product Collection</h2>
                <p className='mb-5'>We sell & buy good qualityful Educational Product with a good deal.</p>
            </div>
            <div>
